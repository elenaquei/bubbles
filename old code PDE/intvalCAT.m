function c=intvalCAT(dim,a,b,varargin)
...
varargin_min = varargin;
varargin_max = varargin;
for i =1:length(varargin)
    varargin_min{i} = inf(varargin{i});
    varargin_max{i} = sup(varargin{i});
end

c_inf = cat(dim, a_min, b_min, varargin_min{:});
c_sup = cat(dim, a_max, b_max, varargin_max{:});

c=infsup(c_inf,c_sup);
