function [Z1vector,new_Z1,Z1_s]=Z1_bound_cont(A0,A1,xBar0,xBar1,alpha0,alpha1,Adagger_delta,old_Z1)
% function [Z1vector,new_Z1,Z1_s]=Z1_bound_cont(A0,A1,xBar0,xBar1,alpha0,alpha1,Adagger_delta,old_Z1)
% 
...
[~,Z_mat1,nodes_col1,nodes_row1]=Z1_bound(A1,xBar1,alpha1);
new_Z1.mat=Z_mat1;
...
if use_intlab
    Z1_extrema=norm_Ximat(max(Z_mat0.sup,Z_mat1.sup),M,N,nodes_col0,nodes_row0);
else
    Z1_extrema=norm_Ximat(max(Z_mat0,Z_mat1),M,N,nodes_col0,nodes_row0);
end
