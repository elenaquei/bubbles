...
for i =1 : n_iter
    ...
    [x1,x_dot_1,F_new] =update(x0,h,x_dot_0,...
    ...
    [flag,Imin,Imax,previous_iter,Yvector,Z0vector,Z1vector,Z2vector,new_step] = ...
        radii_polynomials_cont(x0,x1,DF0,DF1,...
    ...
    if flag <1 % if the validation did not work, redo the previous steps
        ...
        while flag<1 && tries<10
            ...
            use_intlab = temp_use_intval;
            % validate
            [flag,Imin,Imax,~,Yvector,Z0vector,Z1vector,Z2vector,new_step] = radii_polynomials_cont(x0,x1,DF0,DF1,...
    ...
    if decrease_node && ~bool_Hopf
        ...
        use_intlab = temp_use_intval;
        % validate
        [flag] = radii_polynomials_cont(x1_big,x1_small,DF1_big,DF1_small,...
