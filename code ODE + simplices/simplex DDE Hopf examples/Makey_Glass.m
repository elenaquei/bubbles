...
s{4} = 'x^3a \tau Delay(z_0,-1)^2Delay(z_1,-1)';
s{5} = 'x^2a^2\tau Delay(z_0,-1)^3 Delay(z_1,-1)';
s{6} = 'xa^3\tau Delay(z_0,-1)^4Delay(z_1,-1)';

s1 = cell(8,1);
s1_coef = [4,12,12,4,4,12,12,4];
s1{1} = 'a x^3z_1^2';
s1{2} = 'a^2x^2z_0z_1^2';
s1{3} = 'xa^3z_0^2z_1^2';
s1{4} = 'a^4z_0^3z_1^2';
s1{5} = 'a x^7z_1^2';
s1{6} = 'a^2x^2z_0x^4z_1^2';
s1{7} = 'x^5a^3z_0^2z_1^2';
s1{8} = 'a^4x^4z_0^3z_1^2';
...
F2 = append(F2,'-eta');
F1 = 'dot z_0+\delta\tau z_0 -\tau Delay(z_0,-1) + 3\tau Delay(z_0,-1)Delay(z_1,-1)x^4 +  6x^3a \tau Delay(z_0,-1)^2Delay(z_1,-1) + 4x^2a^2\tau Delay(z_0,-1)^3 Delay(z_1,-1)+ xa^3\tau Delay(z_0,-1)^4Delay(z_1,-1)';
F1 = strrep(F1, '\' , '');
F2 = strrep(F2, '\' , '');
...
dz0dxg = @(x,a,z0) 24 *a* (x + a* z0) *(1 + 7* x^4 + 8* a *x^3* z0 + 2 *a^2* x^2 * z0^2);
